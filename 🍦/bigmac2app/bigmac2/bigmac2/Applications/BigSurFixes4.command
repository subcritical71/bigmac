...
echo "Welcome to the BigSurFixes beta\nthis version should fix booting without nvram compat_check and opencore, telemetry kp for Penryn Core2Duo cpus and also attempt to fix Legacy USB, Sound and Wifi making a new snapshot"
...
mv AppleHDA.kext AppleHDA.kext2
mv IOHIDFamily.kext IOHIDFamily.kext2
cp -r /Volumes/"Image Volume"/kext/* .
cd /Volumes/"$label"/System/Library/Extensions/
mv IOHIDFamily.kext1 IOHIDFamily.kext
mv AppleUSBHostMergeProperties.kext2 AppleUSBHostMergeProperties.kext
mv IOUSBHostFamily.kext/Contents/PlugIns/AppleUSBHostMergeProperties.kext IOUSBHostFamily.kext/Contents/PlugIns/AppleUSBHostMergeProperties.kext2
mv AppleUSBHostMergeProperties.kext IOUSBHostFamily.kext/Contents/PlugIns/
chown -R 0:0 /Volumes/"$label"/System/Library/Extensions/
chmod -R 755 /Volumes/"$label"/System/Library/Extensions/
cd ..
cd CoreServices
...
echo "\nDone"
echo "\n\nAfter reboot your BigSur should boot without opencore , Penryn Core2Duo and maybe legacy USB with Sound and Wifi working\n"
