...
do
    case $opt in
	    ...
	    CPUaverageT=$(/Applications/smc.app/Contents/Resources/smc -k TC0D -r|awk '{print $3}')
        ...
        "Set Fans RPM quieter and balanced for CPU cooling")
            ...
            CPUTEMP=$(/Applications/smc.app/Contents/Resources/smc -k TC0D -r|awk '{print $3}')
            CPUTEMP=${CPUTEMP%.*}
        ...
        "CPU temp for Ivy Bridge")
            /Applications/smc.app/Contents/Resources/smc2.command
            ;;
        "Quit")
            break
            ;;
